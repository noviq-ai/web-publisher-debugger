      ...
      <div className="space-y-0">
        ...
        {consent.consentString && (
          <div className="py-1.5 border-b border-border/30">
            ...
            <div className="truncate rounded bg-muted/50 p-1.5 font-mono text-xs" title={consent.consentString}>{consent.consentString}</div>
          </div>
        )}
        ...
        {consent.gppString && (
          <div className="py-1.5">
            ...
            <div className="truncate rounded bg-muted/50 p-1.5 font-mono text-xs" title={consent.gppString}>{consent.gppString}</div>
          </div>
        )}
      </div>
    </Section>
